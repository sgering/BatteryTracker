...
outpath = "C:\\scripts\\OpenCV_AI_Competetion\\depthai-tutorials-practice\\1-hello-world\\output.avi"
...
#detection_nn.setBlobPath("C:\\Users\\Isis\\AppData\\Local\\Programs\\DepthAI\\depthai\\resources\\nn\\custom_model\\custom_model.blob") #this is the path when using depth AI demo
detection_nn.setBlobPath("C:\\scripts\\OpenCV_AI_Competetion\\depthai-tutorials-practice\\1-hello-world\\custom_model\\custom_model.blob")#this is a local version
        ...
        if frame is not None:
            for detection in detections:
                ...
                if detection.label == 4:
                    ...
                    text_label ='Grey ' + str(conf)
                
                # and then draw a rectangle on the frame to show the actual result
                cv2.rectangle(frame, (bbox[0], bbox[1]), (bbox[2], bbox[3]), (255, 0, 0), 1)
                cv2.putText(frame, text_label, (bbox[0], bbox[1]), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (36,255,12), 1)
